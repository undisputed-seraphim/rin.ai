/*
   Parallax Mapping Demo - Chapter 5
...
// Textures.
bbe::BB_TEXTURE g_tex, g_tex2, g_tex3;
...
bbe::ParameterHandle g_heightParam;
...
bool DemoInitialize(bbe::RenderParams &params)
{
  ...
  result = g_Render.LoadTexFromFile("resources/decal.tga",
   ...
   result = g_Render.LoadTexFromFile("resources/height.tga",
                                     BB_TEX2D_TYPE, &g_tex3);
   ...
   g_Render.SetupShaderParameter("parallaxMap", g_shader, &g_heightParam);
...
void DemoRender()
{
   ...
   g_Render.SetShaderParameter4f(g_lightCol, 0.8f, 0.8f, 0.8f, 1);
   g_Render.SetShaderParameter4f(g_camPos, 0, 3, 5, 1);

   g_Render.SetShaderParameter1i(g_decalParam, 0);
   g_Render.SetShaderParameter1i(g_bumpParam, 1);
   g_Render.SetShaderParameter1i(g_heightParam, 2);

   g_Render.ApplyTexture(0, g_tex);
   g_Render.ApplyTexture(1, g_tex2);
   g_Render.ApplyTexture(2, g_tex3);
